...
//    @Scheduled(cron = "0 0/1 * 1/1 * *", zone = "GMT+2")  this is just for testing, it
//    will be deleted later
    public void permanentlyDeleteResources() {
        ...
        serviceTypeRepository.deleteAll(deletedServiceTypes);

        serviceRepository.deleteAll(deletedServices);

        vehicleRepository.deleteAll(deletedVehicles);

        customerRepository.deleteAll(deletedCustomers);
